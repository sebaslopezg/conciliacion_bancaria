...
// Example usage:
// Assuming your data structure, you would call it like this:
// const result = setTransactions(objMain.data.rows, objSecond.data.rows)
// console.log(result.arrMain)    // First array with status indicators
// console.log(result.arrSecond)  // Second array with status indicators
